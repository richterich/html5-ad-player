export default class PlayerOverlay {
  ...
  get activated () {
    return document.querySelector('.player-overlay.visible-box') !== null
  }

  get notActivated () {
    return document.querySelector('.player-overlay.hidden-box') !== null
  }

  get paused () {
    return document.querySelector('.player-pause.visible-box') !== null
  }

  get notPaused () {
    return document.querySelector('.player-pause.hidden-box') !== null
  }

  get spinning () {
    return document.querySelector('.player-spinner.hidden-box') === null
  }
